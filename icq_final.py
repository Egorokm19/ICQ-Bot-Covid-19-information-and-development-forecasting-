...
В качестве функции потерь была взята квадратичная функция, преимуществом которой является инвариантность к знаку - значение функции всегда положительно.Т.е. независимо от знака ошибки результат будет один и тот же.
